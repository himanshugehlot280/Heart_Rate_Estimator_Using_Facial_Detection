...
def home():
    ...
    with st.selectbox:
        selected = option_menu(
            ...
            icons=["house-heart", "clipboard2-pulse", "stopwatch", "person-lines-fill"],
        )
    ...
    st.write("When your heart beats you face changes colour ever-so-slightly because of blood flowing through. Though "
             "this change isn't visible to the naked eye, it can be extracted by a computer program. ")
    st.write("Our application first detects faces and isolates the forehead. it then performs a fast fourier transform. "
    ...
    st.markdown("<hr>", unsafe_allow_html=True)
    st.write("The functions of the heart are to pump blood and oxygen around the body and deliver waste products carbon "
