...
#
#
# def aaverage(face_frames, fps):
#     target_duration = 10
#     value_list = []
#     start_time = time.time()
#     while time.time() - start_time < target_duration:
#         estimated_heart_rate = estimate_heart_rate(face_frames, fps)
#         value_list.append(estimated_heart_rate)
#         time.sleep(1 / fps)  # Adjust sleep duration to match your frame rate
#
#     average_hr = sum(value_list) / len(value_list)
#     return average_hr
#
#
#
...
#             fps = 30
#             estimated_heart_rate = estimate_heart_rate(face_frame,ret)
#
#
